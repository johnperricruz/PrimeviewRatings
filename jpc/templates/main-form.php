...
'
	...
	if(isset($_GET['msg']) && ($_GET['msg'] == 'success') ) {$return .='<div class="pv-success"><h4>Thanks! Your Response has been submitted!</h4></div>';}
		...
		<div class="pv-body">
			...
			<div class="pv-separator"><h4>Write a Review</h4></div>
			<div id="pv-review">
				<form action="'.plugins_url().'/primeview-plugin/jpc/data/post.php'.'" method="POST" >
				<input type="hidden" name="redirect" value="'.$_SERVER['REQUEST_URI'].'"/>
				<div class="wrap grid">
					<div class="pv-b unit w-1-2">
						<span class="pv-or">OR</span>
					...
					<div class="review-forms-third-party unit w-1-2">
				...
				<div class="pv-separator"><h4>Your Info</h4></div>
				<div class="wrap grid">
					<div class="unit w-1-2">	
