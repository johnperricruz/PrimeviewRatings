...
if(isset($btnEdit)){
	...
	$review = $add->insertReview($LastReviewerID,$pv_service_rating,$pv_recommend_rating,$pv_total_exp_rating,stripslashes($pvReviewSummary),stripslashes($pvReviewReview));
