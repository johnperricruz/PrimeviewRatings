...
class insert_model extends database_model{	
	...
	public function insertReview($LastReviewerID,$pv_service_rating,$pv_recommend_rating,$pv_total_exp_rating,$pvReviewSummary,$pvReviewReview){
		$db = $this->db_connect();
		
		$sql="INSERT INTO ".$this->review."
		(ReviewerID,Service,WillRecommend,TotalExperience,ReviewSummary,Review) VALUES 
		('".$LastReviewerID."','".$pv_service_rating."','".$pv_recommend_rating."','".$pv_total_exp_rating."','".$pvReviewSummary."','".$pvReviewReview."')  ";
		$result = $db->query($sql);
